...
**24. Three pages now send you to Inspector tabs that do not exist**
...
**25. Message history: the recommended recipe is a prop no release has, and on this backend the middleware erases the agent's memory**
