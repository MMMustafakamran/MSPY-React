...
Skill delivery does not send native agent runs to Automatic Learning. To collect new evidence, also [assign your Runtime's Threads to a container](/ms-agent-python/learning#assign-threads-from-your-runtime).
...
See the [Automatic Learning guide](/ms-agent-python/learning) for the manual workflow.
