...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/ms-agent-python/intelligence/quickstart#set-it-up-manually). That page signs you in with the CLI, selects the project, and configures server-side user identity. Your existing app and agent stay in place.
  </Step>
...
- **Threads:** [Threads & Persistence Architecture](/ms-agent-python/intelligence/threads-explained), the
  persistence model for a single conversation
- **Platform:** [CopilotKit Intelligence](/ms-agent-python/intelligence/overview), where
  memory sits among the other pillars
- **Self-hosting:** [Self-hosting Intelligence](/ms-agent-python/intelligence/self-hosting),
