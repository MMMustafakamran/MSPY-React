...
[generative UI](/ms-agent-python/generative-ui/tool-rendering) is for: the agent calls a tool and
...
- [Slots](/ms-agent-python/custom-look-and-feel/slots) — how slot overrides work in general.
